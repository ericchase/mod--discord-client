...
const logger = Logger(Processor_SASSCompiler.name);

export function Processor_SASSCompiler(): ProcessorModule {
  return new CProcessor_SASSCompiler();
}

class CProcessor_SASSCompiler implements ProcessorModule {
